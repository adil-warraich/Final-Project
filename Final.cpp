...
int main()
{
	...
	while (true)   // Loop to run the code until the user don't want to exit the Program . 
	{
		...
		case'5':
			...
			cout << "\n1.For Searching Team Players." << endl ;
			cout << "2.For Searching Player Details." << endl ;
            ...
            // For Searching Team players Only ! It starts at Line "276"

			case '1':  

				exiting = true;
				while (exiting)  // Loop if the user wants to see other Teams Players also !
				{
					cout << "\nSelect the Team to see its Players : " << endl << endl;
			  ...
			  break;
			  //For Searching Team Players only Ends Here at Line "391" 


			  //For Searching Team Players Details !! It Starts at "394" 
			  case'2':
				  ...
				  while (exiting) // Loop if User wants to see other Teams Players Details !
				  {
					  ...
					  switch (searchingteam)
					  {
					  case'1':  // For Team-1 Lahore Qalandars !
					  ...
					  case'2':  // For Team-2 Peshawar Zalmi !
					  ...
					  case'3': // For Team-3 QuettaGladiators !
					  ...
					  case'4': // For Team-4 Islamabad United !
					  ...
					  case'5': // For Team-5 Multan Sultan !
					  ...
					  case'6': // For Team-6 Karachi Kings
			...
			// Searching For Player Details End Here at Line "672" 
